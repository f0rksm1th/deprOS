...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1542539278);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1542531846);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1542531479);
...
user_pref("browser.uiCustomization.state", "{\"placements\":{\"widget-overflow-fixed-list\":[],\"PersonalToolbar\":[\"personal-bookmarks\"],\"nav-bar\":[\"home-button\",\"torbutton-button\",\"stop-reload-button\",\"back-button\",\"forward-button\",\"urlbar-container\"],\"TabsToolbar\":[\"tabbrowser-tabs\",\"alltabs-button\"],\"toolbar-menubar\":[\"menubar-items\"],\"PanelUI-contents\":[\"home-button\",\"edit-controls\",\"zoom-controls\",\"new-window-button\",\"save-page-button\",\"print-button\",\"bookmarks-menu-button\",\"history-panelmenu\",\"find-button\",\"preferences-button\",\"add-ons-button\",\"developer-button\",\"https-everywhere-button\"],\"addon-bar\":[\"addonbar-closebutton\",\"status-bar\"]},\"seen\":[\"developer-button\",\"https-everywhere_eff_org-browser-action\",\"_73a6fe31-595d-460b-a920-fcc0f8843232_-browser-action\",\"https-everywhere-eff_eff_org-browser-action\"],\"dirtyAreaCache\":[\"PersonalToolbar\",\"nav-bar\",\"TabsToolbar\",\"toolbar-menubar\",\"widget-overflow-fixed-list\"],\"currentVersion\":14,\"newElementCount\":4}");
...
user_pref("extensions.torbutton.lastUpdateCheck", "1542539196.72");
...
user_pref("toolkit.startup.last_success", 1542542373);
